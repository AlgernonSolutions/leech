...
first_rule_specifiers = FunctionSpecifier('changed_target', 'derive_change_targeted', ['id_source', 'id_type', 'id_name', 'id_value'])
...
second_potential_vertex = PotentialVertex('ChangeLogEntry', second_potential_internal_id, second_potential_vertex_properties, 'stub', second_potential_identifier_stem, 3889, 'id_value')

second_rule_constants = []
second_rule_specifiers = SharedPropertySpecifier('changelog_source', ['id_source', 'changelog_id'])
second_rule = VertexLinkRuleEntry('ChangeLogEntry', '_change_', second_rule_constants, second_rule_specifiers, 'stub', True)
